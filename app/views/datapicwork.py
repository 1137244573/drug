...
def datapic_chu(request):
    ...
    return render(request, 'datapicwork_chu.html', context)
...
def datapic_ru(request):
    ...
    return render(request, 'datapicwork_ru.html', context)
...
def datapic_num(request):
    ...
    return render(request, 'datapicwork_num.html', context)
...
def datapic_chuhuan(request):
    ...
    return render(request, 'datapicwork_chuhuan.html', context)
...
def datapic_ruhuan(request):
    ...
    return render(request, 'datapicwork_ruhuan.html', context)
...
def datapic_baoxian(request):
    ...
    return render(request, 'datapicwork_baoxian.html', context)
...
def datapic_kangjun(request):
    ...
    return render(request, 'datapicwork_kangjun.html', context)
...
def datapic_zhong(request):
    ...
    return render(request, 'datapicwork_zhong.html', context)
...
def datapic_money(request):
    ...
    return render(request, 'datapicwork_money.html', context)